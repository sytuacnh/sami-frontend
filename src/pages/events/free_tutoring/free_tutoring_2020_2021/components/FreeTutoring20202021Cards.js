...
class FreeTutoring20202021Cards extends PureComponent {
    render() {
            ...
            <Fragment>
                <GridContainer>
                    <GridItem xs={12} sm={6} md={6}>
                      ...
                      >
                        <CardBody background>
                          <h6 className={classes.category}>Free Tutoring 2020-2021</h6>
                          ...
                          <a className="link" href="https://forms.gle/rDgjDbH2DVTq1UNr6" target="_blank" rel="noopener noreferrer">
                    ...
                    <GridItem xs={12} sm={6} md={6}>
                      ...
                      >
                        <CardBody background>
                          ...
                          <a className="link" href="https://forms.gle/9yM2emBLjyBaKrsB9" target="_blank" rel="noopener noreferrer">
                              <Button round color="rose">
                                  <FormatAlignLeft className={classes.icons} />Sign Up
                              </Button>
                          </a>
...
export default withStyles(featuresStyle)(FreeTutoring20202021Cards);
