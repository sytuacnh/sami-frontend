...
import poster from "../../../../../static/events/summer_at_sami/pdf/SaMiSummerCamp2021.pdf";
import curriculum from "../../../../../static/events/summer_at_sami/pdf/SaMiSummerCampCurriculum2021.pdf";
            ...
            <Fragment>
                <GridContainer>
                  <GridItem xs={12} sm={6} md={6}>
                    ...
                    >
                      <CardBody background>
                        <h6 className={classes.category}>Summer@SaMi 2021</h6>
                        ...
                        <a className="link" href="https://forms.gle/uaDcrmgtSq9j97kz8" target="_blank" rel="noopener noreferrer">
                  ...
                  <GridItem xs={12} sm={6} md={6}>
                    ...
                    >
                      <CardBody background>
                        ...
                        <a className="link" href="https://forms.gle/GFUvQKhsiVSqwumc6" target="_blank" rel="noopener noreferrer">
                            <Button round color="rose">
                                <FormatAlignLeft className={classes.icons} />Sign Up
                            </Button>
                        </a>
